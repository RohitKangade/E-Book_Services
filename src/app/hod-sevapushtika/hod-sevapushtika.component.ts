...
@Component({
  selector: 'app-hod-sevapushtika',
  templateUrl: './hod-sevapushtika.component.html',
  styleUrl: './hod-sevapushtika.component.css'
})
export class HodSevapushtikaComponent implements OnInit {
  empData: any = {};
