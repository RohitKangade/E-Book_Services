...
@Component({
  selector: 'app-hod-noteabstract',
  templateUrl: './hod-noteabstract.component.html',
  styleUrl: './hod-noteabstract.component.css'
})
export class HodNoteabstractComponent implements OnInit {
